...
// Source file: Area.proto at 36:1
...
public final class CityDetailInfo extends Message<CityDetailInfo, CityDetailInfo.Builder> {
  public static final ProtoAdapter<CityDetailInfo> ADAPTER = new ProtoAdapter_CityDetailInfo();
  ...
  public CityDetailInfo(Integer provinceId, String provinceName, Integer cityId, String cityName) {
    this(provinceId, provinceName, cityId, cityName, ByteString.EMPTY);
  }

  public CityDetailInfo(Integer provinceId, String provinceName, Integer cityId, String cityName, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof CityDetailInfo)) return false;
    CityDetailInfo o = (CityDetailInfo) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "CityDetailInfo{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<CityDetailInfo, Builder> {
    ...
    public CityDetailInfo build() {
      return new CityDetailInfo(provinceId, provinceName, cityId, cityName, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_CityDetailInfo extends ProtoAdapter<CityDetailInfo> {
    ProtoAdapter_CityDetailInfo() {
      super(FieldEncoding.LENGTH_DELIMITED, CityDetailInfo.class);
    }

    @Override
    public int encodedSize(CityDetailInfo value) {
    ...
    @Override
    public void encode(ProtoWriter writer, CityDetailInfo value) throws IOException {
    ...
    @Override
    public CityDetailInfo decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public CityDetailInfo redact(CityDetailInfo value) {
