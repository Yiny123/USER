...
// Source file: Area.proto at 42:1
...
public final class CountyDetailInfo extends Message<CountyDetailInfo, CountyDetailInfo.Builder> {
  public static final ProtoAdapter<CountyDetailInfo> ADAPTER = new ProtoAdapter_CountyDetailInfo();
  ...
  public CountyDetailInfo(Integer provinceId, String provinceName, Integer cityId, String cityName, Integer countyId, String countyName, Integer cityCode) {
    this(provinceId, provinceName, cityId, cityName, countyId, countyName, cityCode, ByteString.EMPTY);
  }

  public CountyDetailInfo(Integer provinceId, String provinceName, Integer cityId, String cityName, Integer countyId, String countyName, Integer cityCode, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof CountyDetailInfo)) return false;
    CountyDetailInfo o = (CountyDetailInfo) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "CountyDetailInfo{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<CountyDetailInfo, Builder> {
    ...
    public CountyDetailInfo build() {
      return new CountyDetailInfo(provinceId, provinceName, cityId, cityName, countyId, countyName, cityCode, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_CountyDetailInfo extends ProtoAdapter<CountyDetailInfo> {
    ProtoAdapter_CountyDetailInfo() {
      super(FieldEncoding.LENGTH_DELIMITED, CountyDetailInfo.class);
    }

    @Override
    public int encodedSize(CountyDetailInfo value) {
      return (value.provinceId != null ? ProtoAdapter.UINT32.encodedSizeWithTag(1, value.provinceId) : 0)
          ...
          + (value.cityCode != null ? ProtoAdapter.UINT32.encodedSizeWithTag(7, value.cityCode) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, CountyDetailInfo value) throws IOException {
      ...
      if (value.cityCode != null) ProtoAdapter.UINT32.encodeWithTag(writer, 7, value.cityCode);
      writer.writeBytes(value.unknownFields());
    }

    @Override
    public CountyDetailInfo decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 7: builder.cityCode(ProtoAdapter.UINT32.decode(reader)); break;
          default: {
    ...
    @Override
    public CountyDetailInfo redact(CountyDetailInfo value) {
