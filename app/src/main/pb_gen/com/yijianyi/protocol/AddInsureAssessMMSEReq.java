...
// Source file: AppInterface.proto at 684:1
 ...
 * 	护士MMSE评估
 */
public final class AddInsureAssessMMSEReq extends Message<AddInsureAssessMMSEReq, AddInsureAssessMMSEReq.Builder> {
  public static final ProtoAdapter<AddInsureAssessMMSEReq> ADAPTER = new ProtoAdapter_AddInsureAssessMMSEReq();
  ...
  public AddInsureAssessMMSEReq(String insureNO, Integer isCommit, String composure, Integer isMemory, Integer isMind, Integer isRecall, Integer isRename, Integer isRetell, Integer isThree, Integer isWrite, Integer isRead, Integer isStruct, String memoryRemark, String mindRemark, String recallRemark, String renameRemark, String retellRemark, String threeRemark, String writeRemark, String readRemark, String structRemark) {
    this(insureNO, isCommit, composure, isMemory, isMind, isRecall, isRename, isRetell, isThree, isWrite, isRead, isStruct, memoryRemark, mindRemark, recallRemark, renameRemark, retellRemark, threeRemark, writeRemark, readRemark, structRemark, ByteString.EMPTY);
  }

  public AddInsureAssessMMSEReq(String insureNO, Integer isCommit, String composure, Integer isMemory, Integer isMind, Integer isRecall, Integer isRename, Integer isRetell, Integer isThree, Integer isWrite, Integer isRead, Integer isStruct, String memoryRemark, String mindRemark, String recallRemark, String renameRemark, String retellRemark, String threeRemark, String writeRemark, String readRemark, String structRemark, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AddInsureAssessMMSEReq)) return false;
    AddInsureAssessMMSEReq o = (AddInsureAssessMMSEReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "AddInsureAssessMMSEReq{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<AddInsureAssessMMSEReq, Builder> {
    ...
    public AddInsureAssessMMSEReq build() {
      return new AddInsureAssessMMSEReq(insureNO, isCommit, composure, isMemory, isMind, isRecall, isRename, isRetell, isThree, isWrite, isRead, isStruct, memoryRemark, mindRemark, recallRemark, renameRemark, retellRemark, threeRemark, writeRemark, readRemark, structRemark, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_AddInsureAssessMMSEReq extends ProtoAdapter<AddInsureAssessMMSEReq> {
    ProtoAdapter_AddInsureAssessMMSEReq() {
      super(FieldEncoding.LENGTH_DELIMITED, AddInsureAssessMMSEReq.class);
    }

    @Override
    public int encodedSize(AddInsureAssessMMSEReq value) {
      return (value.insureNO != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.insureNO) : 0)
          ...
          + (value.composure != null ? ProtoAdapter.STRING.encodedSizeWithTag(3, value.composure) : 0)
    ...
    @Override
    public void encode(ProtoWriter writer, AddInsureAssessMMSEReq value) throws IOException {
      ...
      if (value.composure != null) ProtoAdapter.STRING.encodeWithTag(writer, 3, value.composure);
    ...
    @Override
    public AddInsureAssessMMSEReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 3: builder.composure(ProtoAdapter.STRING.decode(reader)); break;
    ...
    @Override
    public AddInsureAssessMMSEReq redact(AddInsureAssessMMSEReq value) {
