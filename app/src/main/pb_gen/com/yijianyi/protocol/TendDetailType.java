...
// Source file: Insure.proto at 8:1
 ...
 * 照护明细类型
 */
public final class TendDetailType extends Message<TendDetailType, TendDetailType.Builder> {
  public static final ProtoAdapter<TendDetailType> ADAPTER = new ProtoAdapter_TendDetailType();
  ...
  public TendDetailType(Long id, String typeName, String remark, Integer status, Long createStaffId, String createStaffName, Long createTime, Long companyId) {
    this(id, typeName, remark, status, createStaffId, createStaffName, createTime, companyId, ByteString.EMPTY);
  }

  public TendDetailType(Long id, String typeName, String remark, Integer status, Long createStaffId, String createStaffName, Long createTime, Long companyId, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof TendDetailType)) return false;
    TendDetailType o = (TendDetailType) other;
    return unknownFields().equals(o.unknownFields())
        && Internal.equals(id, o.id)
        && Internal.equals(typeName, o.typeName)
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (typeName != null ? typeName.hashCode() : 0);
  ...
  public String toString() {
    ...
    if (typeName != null) builder.append(", typeName=").append(typeName);
    ...
    return builder.replace(0, 2, "TendDetailType{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<TendDetailType, Builder> {
    public Long id;
    ...
    public TendDetailType build() {
      return new TendDetailType(id, typeName, remark, status, createStaffId, createStaffName, createTime, companyId, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_TendDetailType extends ProtoAdapter<TendDetailType> {
    ProtoAdapter_TendDetailType() {
      super(FieldEncoding.LENGTH_DELIMITED, TendDetailType.class);
    }

    @Override
    public int encodedSize(TendDetailType value) {
      return (value.id != null ? ProtoAdapter.UINT64.encodedSizeWithTag(1, value.id) : 0)
          + (value.typeName != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.typeName) : 0)
    ...
    @Override
    public void encode(ProtoWriter writer, TendDetailType value) throws IOException {
      if (value.id != null) ProtoAdapter.UINT64.encodeWithTag(writer, 1, value.id);
      if (value.typeName != null) ProtoAdapter.STRING.encodeWithTag(writer, 2, value.typeName);
    ...
    @Override
    public TendDetailType decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      long token = reader.beginMessage();
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          case 1: builder.id(ProtoAdapter.UINT64.decode(reader)); break;
          case 2: builder.typeName(ProtoAdapter.STRING.decode(reader)); break;
    ...
    @Override
    public TendDetailType redact(TendDetailType value) {
