...
// Source file: AppInterface.proto at 1848:1
 ...
 * 新增变更回访记录质控内容信息
 */
public final class SaveOrUpdateInsureOrderVisitQualityReq extends Message<SaveOrUpdateInsureOrderVisitQualityReq, SaveOrUpdateInsureOrderVisitQualityReq.Builder> {
  public static final ProtoAdapter<SaveOrUpdateInsureOrderVisitQualityReq> ADAPTER = new ProtoAdapter_SaveOrUpdateInsureOrderVisitQualityReq();
  ...
  public static final Long DEFAULT_QUALITYID = 0L;
  ...
  public SaveOrUpdateInsureOrderVisitQualityReq(String orderId, Long visitId, Long qualityId, Integer floor, Integer toilet, Integer bed, Integer tables, Integer hair, Integer oralCavity, Integer skin, Integer perineum, Integer clothing, Integer diet, Integer sleep, Integer feces, Integer skinFull, Integer mentality, Integer discomfort, String discomfortDetial, Integer result, String resultDetial, Integer kitchen) {
    this(orderId, visitId, qualityId, floor, toilet, bed, tables, hair, oralCavity, skin, perineum, clothing, diet, sleep, feces, skinFull, mentality, discomfort, discomfortDetial, result, resultDetial, kitchen, ByteString.EMPTY);
  }

  public SaveOrUpdateInsureOrderVisitQualityReq(String orderId, Long visitId, Long qualityId, Integer floor, Integer toilet, Integer bed, Integer tables, Integer hair, Integer oralCavity, Integer skin, Integer perineum, Integer clothing, Integer diet, Integer sleep, Integer feces, Integer skinFull, Integer mentality, Integer discomfort, String discomfortDetial, Integer result, String resultDetial, Integer kitchen, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof SaveOrUpdateInsureOrderVisitQualityReq)) return false;
    SaveOrUpdateInsureOrderVisitQualityReq o = (SaveOrUpdateInsureOrderVisitQualityReq) other;
    return unknownFields().equals(o.unknownFields())
        && Internal.equals(orderId, o.orderId)
        && Internal.equals(visitId, o.visitId)
        && Internal.equals(qualityId, o.qualityId)
  ...
  public int hashCode() {
    ...
    if (result_ == 0) {
      ...
      result_ = result_ * 37 + (orderId != null ? orderId.hashCode() : 0);
      result_ = result_ * 37 + (visitId != null ? visitId.hashCode() : 0);
      result_ = result_ * 37 + (qualityId != null ? qualityId.hashCode() : 0);
  ...
  public String toString() {
    ...
    if (qualityId != null) builder.append(", qualityId=").append(qualityId);
    ...
    return builder.replace(0, 2, "SaveOrUpdateInsureOrderVisitQualityReq{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<SaveOrUpdateInsureOrderVisitQualityReq, Builder> {
     ...
     * 质控内容id,新增是为0
     */
    public Builder qualityId(Long qualityId) {
      this.qualityId = qualityId;
      return this;
    }
    ...
    @Override
    public SaveOrUpdateInsureOrderVisitQualityReq build() {
      return new SaveOrUpdateInsureOrderVisitQualityReq(orderId, visitId, qualityId, floor, toilet, bed, tables, hair, oralCavity, skin, perineum, clothing, diet, sleep, feces, skinFull, mentality, discomfort, discomfortDetial, result, resultDetial, kitchen, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_SaveOrUpdateInsureOrderVisitQualityReq extends ProtoAdapter<SaveOrUpdateInsureOrderVisitQualityReq> {
    ProtoAdapter_SaveOrUpdateInsureOrderVisitQualityReq() {
      super(FieldEncoding.LENGTH_DELIMITED, SaveOrUpdateInsureOrderVisitQualityReq.class);
    }

    @Override
    public int encodedSize(SaveOrUpdateInsureOrderVisitQualityReq value) {
      return (value.orderId != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.orderId) : 0)
          ...
          + (value.qualityId != null ? ProtoAdapter.UINT64.encodedSizeWithTag(3, value.qualityId) : 0)
          + (value.floor != null ? ProtoAdapter.UINT32.encodedSizeWithTag(4, value.floor) : 0)
          ...
          + (value.kitchen != null ? ProtoAdapter.UINT32.encodedSizeWithTag(22, value.kitchen) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, SaveOrUpdateInsureOrderVisitQualityReq value) throws IOException {
      ...
      if (value.qualityId != null) ProtoAdapter.UINT64.encodeWithTag(writer, 3, value.qualityId);
      if (value.floor != null) ProtoAdapter.UINT32.encodeWithTag(writer, 4, value.floor);
      ...
      if (value.kitchen != null) ProtoAdapter.UINT32.encodeWithTag(writer, 22, value.kitchen);
      writer.writeBytes(value.unknownFields());
    }

    @Override
    public SaveOrUpdateInsureOrderVisitQualityReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 3: builder.qualityId(ProtoAdapter.UINT64.decode(reader)); break;
          case 4: builder.floor(ProtoAdapter.UINT32.decode(reader)); break;
          ...
          case 22: builder.kitchen(ProtoAdapter.UINT32.decode(reader)); break;
          default: {
    ...
    @Override
    public SaveOrUpdateInsureOrderVisitQualityReq redact(SaveOrUpdateInsureOrderVisitQualityReq value) {
