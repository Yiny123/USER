...
// Source file: AppInterface.proto at 80:1
 ...
 * 添加用户地址消息体
 */
public final class UserAddressReq extends Message<UserAddressReq, UserAddressReq.Builder> {
  public static final ProtoAdapter<UserAddressReq> ADAPTER = new ProtoAdapter_UserAddressReq();
  ...
  public UserAddressReq(Long addrId, String addrDetail, String adCode, String street, String building, Integer gpsType, Double lng, Double lat, Integer defaultUse, String phone, String contacts, Long userId) {
    this(addrId, addrDetail, adCode, street, building, gpsType, lng, lat, defaultUse, phone, contacts, userId, ByteString.EMPTY);
  }

  public UserAddressReq(Long addrId, String addrDetail, String adCode, String street, String building, Integer gpsType, Double lng, Double lat, Integer defaultUse, String phone, String contacts, Long userId, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof UserAddressReq)) return false;
    UserAddressReq o = (UserAddressReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "UserAddressReq{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<UserAddressReq, Builder> {
    public Long addrId;
    ...
    public UserAddressReq build() {
      return new UserAddressReq(addrId, addrDetail, adCode, street, building, gpsType, lng, lat, defaultUse, phone, contacts, userId, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_UserAddressReq extends ProtoAdapter<UserAddressReq> {
    ProtoAdapter_UserAddressReq() {
      super(FieldEncoding.LENGTH_DELIMITED, UserAddressReq.class);
    }

    @Override
    public int encodedSize(UserAddressReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, UserAddressReq value) throws IOException {
    ...
    @Override
    public UserAddressReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public UserAddressReq redact(UserAddressReq value) {
