...
import com.yjy.user.utils.ActivityHelper;
...
/**
 * Created by liny on 2018/4/4. 20:27
 */
public abstract class BaseActivity<V extends MvpView, P extends MvpPresenter<V>> extends MvpActivity<V, P> implements ISupportActivity {
    ...
    private void initLayout() {
        ...
        this.view = LayoutInflater.from(this).inflate(resource.value(), null, false);
    ...
    public void showLoading() {
        if (loadingView != null)
            this.loadingView.setStatus(LoadingLayout.Loading);
    }

    public void showLoadingError() {
        if (loadingView != null)
            this.loadingView.setStatus(LoadingLayout.Error);
    }

    public void stopLoading() {
        if (loadingView != null)
            this.loadingView.setStatus(LoadingLayout.Success);
    }

    protected void toast(String msg) {
        Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
    }
/*=======================Isupport Activity start========================================*/
